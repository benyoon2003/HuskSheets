...
public class ServerEndpoint {
  ...
  private static String BASE_URL = "http://localhost:8080/api/v1/";//"http://localhost:8080/api/v1/";////"http://localhost:8080/api/v1/";//ConfigLoader.getProperty("base.url");//"http://localhost:8080/api/v1/";//ConfigLoader.getProperty("base.url");//ConfigLoader.getProperty("base.url");  //"http://localhost:8080/api/v1/";  //ConfigLoader.getProperty("base.url");
